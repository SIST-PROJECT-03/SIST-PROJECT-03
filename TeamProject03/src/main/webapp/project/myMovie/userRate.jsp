		...
		<div class="row ipad-width2">
			...
			<div class="col-md-9 col-sm-12 col-xs-12">
				<div class="topbar-filter">
					<p>총 <span>77 </span> 개의 리뷰</p>
					<!-- <label>Sort by:</label> -->
					<select>
						<option value="range">등록일순</option>
						<option value="saab">평점순</option>
					</select>
				</div>
				<div class="movie-item-style-2 userrate">
					...
					<div class="mv-item-infor">
						...
						<p class="rate"><i class="ion-android-star"></i><span>9.0</span> /10</p><br>
				...
				<div class="movie-item-style-2 userrate last">
					...
					<div class="mv-item-infor">
						...
						<p class="time sm-text">나의 평점</p>
						<p class="rate"><i class="ion-android-star"></i><span>10.0</span> /10</p><br>	
						<p class="time sm-text">나의 리뷰</p>
						<h6>A masterpiece!</h6>
